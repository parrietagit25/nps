...
class SendGridService {
    ...
    public function __construct() {
        ...
        $this->sendgrid = new SendGrid($_ENV['SENDGRID_API_KEY'] ?? 'SG.your-api-key-here');
        $this->from_email = $_ENV['FROM_EMAIL'] ?? 'notificaciones@grupopcr.com.pa';
        $this->from_name = $_ENV['FROM_NAME'] ?? 'PCR notificaciones';
    }
